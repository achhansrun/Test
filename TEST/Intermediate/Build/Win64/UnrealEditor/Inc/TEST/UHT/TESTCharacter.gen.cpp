...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ATESTCharacter_Statics::NewProp_CameraBoom = { "CameraBoom", nullptr, (EPropertyFlags)0x00400000000a001d, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ATESTCharacter, CameraBoom), Z_Construct_UClass_USpringArmComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ATESTCharacter_Statics::NewProp_CameraBoom_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ATESTCharacter_Statics::NewProp_CameraBoom_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ATESTCharacter_Statics::NewProp_TurnRateGamepad = { "TurnRateGamepad", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ATESTCharacter, TurnRateGamepad), METADATA_PARAMS(Z_Construct_UClass_ATESTCharacter_Statics::NewProp_TurnRateGamepad_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ATESTCharacter_Statics::NewProp_TurnRateGamepad_MetaData)) };
	...
	struct Z_CompiledInDeferFile_FID_Users_Fals3_Desktop_Summer_Repo_Test_TEST_Source_TEST_TESTCharacter_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Fals3_Desktop_Summer_Repo_Test_TEST_Source_TEST_TESTCharacter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ATESTCharacter, ATESTCharacter::StaticClass, TEXT("ATESTCharacter"), &Z_Registration_Info_UClass_ATESTCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATESTCharacter), 1600219908U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Fals3_Desktop_Summer_Repo_Test_TEST_Source_TEST_TESTCharacter_h_3502435652(TEXT("/Script/TEST"),
		Z_CompiledInDeferFile_FID_Users_Fals3_Desktop_Summer_Repo_Test_TEST_Source_TEST_TESTCharacter_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Fals3_Desktop_Summer_Repo_Test_TEST_Source_TEST_TESTCharacter_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
